...
class APIFunc {
    class func getAPIWithoutBaseURL(_ url: String, completion: @escaping ( _ json:JSON) -> ()) {
...
//            manager.configuration.timeoutIntervalForRequest = 80
    ...
    class func postAPI_Image(_ url: String,_ imageData: Data?,_ parameters: [String : String],_ img_param:String, completion:@escaping ( _ json:JSON)->()) {
        if Reachability.isConnectedToNetwork() {
